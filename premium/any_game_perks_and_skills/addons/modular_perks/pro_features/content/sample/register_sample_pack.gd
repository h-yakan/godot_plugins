...
const BASE_PATH := "res://addons/modular_perks/pro_features/content/sample/"
const CatalogScript := preload("res://addons/modular_perks/pro_features/content/sample/sample_catalog.gd")
