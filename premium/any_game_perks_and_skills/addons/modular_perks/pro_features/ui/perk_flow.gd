...
const SELECTION_SCENE := preload("res://addons/modular_perks/pro_features/ui/perk_selection_screen.tscn")
const TARGET_SCENE := preload("res://addons/modular_perks/pro_features/ui/perk_target_pick_ui.tscn")
