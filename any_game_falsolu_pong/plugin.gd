...
const BASE_PATH := "res://godot_plugins/any_game_falsolu_pong/"
const GaPongBallScript := preload(BASE_PATH + "scripts/ga_pong_ball.gd")
const GaPongPaddleScript := preload(BASE_PATH + "scripts/ga_pong_paddle.gd")
const GaPongCourtScript := preload(BASE_PATH + "scripts/ga_pong_court.gd")
